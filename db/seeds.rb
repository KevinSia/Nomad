...
quest_6 = Quest.create(title: 'Soul-searching in Bali',duration: '3',country:'Indonesia',city:'Bali',category:'Friends',description:'Rejuvenate your soul in Bali',user_id:1, featured: 1)
...
quest_7 = Quest.create(title: 'Discover the Mysterious Egypt',duration: '3',country:'Egypt',city:'Cairo',category:'Couple',description:'Immerse in the mysterious vibe of Egypt with your better half!',user_id:1, featured: 1)
